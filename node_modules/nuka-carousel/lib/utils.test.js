...
describe('isSlideVisible', () => {
  ...
  `('works with left align ' +
        ...
        expect((0, utils_1.isSlideVisible)(currentSlide, indexToCheck, slidesToShow, types_1.Alignment.Left)).toEqual(expected);
    });
    it.each `
    currentSlide | indexToCheck | slidesToShow | expected
    ${1}         | ${-1}        | ${2}         | ${false}
  ...
  `('works with right align ' +
        '(showing index $currentSlide, check index $indexToCheck, $slidesToShow slidesToShow)', ({ currentSlide, indexToCheck, slidesToShow, expected }) => {
        expect((0, utils_1.isSlideVisible)(currentSlide, indexToCheck, slidesToShow, types_1.Alignment.Right)).toEqual(expected);
    });
    it.each `
    currentSlide | indexToCheck | slidesToShow | expected
    ${1}         | ${-1}        | ${3}         | ${false}
  ...
  `('works with center align ' +
        '(showing index $currentSlide, check index $indexToCheck, $slidesToShow slidesToShow)', ({ currentSlide, indexToCheck, slidesToShow, expected }) => {
        expect((0, utils_1.isSlideVisible)(currentSlide, indexToCheck, slidesToShow, types_1.Alignment.Center)).toEqual(expected);
    });
});
describe('getNextMoveIndex', () => {
  ...
  `('does basic calculation with wrapAround=true ' +
        ...
        expect((0, utils_1.getNextMoveIndex)(...args, types_1.Alignment.Left)).toEqual(expected);
        expect((0, utils_1.getNextMoveIndex)(...args, types_1.Alignment.Right)).toEqual(expected);
        expect((0, utils_1.getNextMoveIndex)(...args, types_1.Alignment.Center)).toEqual(expected);
    });
    it.each `
...
describe('getPrevMoveIndex', () => {
  ...
  `('does basic calculation with wrapAround=true ' +
        ...
        expect((0, utils_1.getPrevMoveIndex)(types_1.ScrollMode.page, true, currentSlide, slidesToScroll, 1, types_1.Alignment.Left)).toEqual(expected);
    });
    it.each `
    currentSlide | slidesToShow | slidesToScroll | cellAlign   | expected
    ${0}         | ${1}         | ${1}           | ${'left'}   | ${0}
